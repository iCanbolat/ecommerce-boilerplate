...
import { ChevronRight, User2Icon, X } from 'lucide-react';
...
const ProjectNavigation = ({
  ...
  return (
    <motion.nav
      ...
      className={`h-full flex flex-col gap-8 w-64 absolute bg-slate-900 z-40 ml-0 ${
        isOpen ? 'left-64' : 'left-20'
      } border-r border-slate-800 p-5`}
    >
      ...
      <div className='flex flex-col gap-3'>
        <NavigationLink name='Progress'>
          <ChevronRight className='stroke-[0.75] stroke-inherit min-w-8 w-8' />
        </NavigationLink>
      ...
      <div className='flex flex-col gap-5'>
        ...
        <a href='#' className='flex flex-row gap-3 place-items-center'>
          <User2Icon className='w-8 p-1 rounded-full stroke-2 stroke-rose-800 bg-rose-200/70' />
          <p className='tracking-wide text-neutral-400'>Steve Jobs</p>
        </a>
        <a href='#' className='flex flex-row gap-3 place-items-center'>
          <User2Icon className='w-8 p-1 rounded-full stroke-2 stroke-emerald-800 bg-emerald-200/70' />
          <p className='tracking-wide text-neutral-400'>Bill Gates</p>
        </a>
        <a href='#' className='flex flex-row gap-3 place-items-center'>
          <User2Icon className='w-8 p-1 rounded-full stroke-2 stroke-indigo-800 bg-indigo-200/70' />
